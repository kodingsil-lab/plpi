...
<div class="dashboard-card letters-table-card myletters-table-card">
  <div class="card-header border-0 bg-transparent d-flex justify-content-between align-items-center">
    <h6 class="mb-0">Daftar Publisher</h6>
    <div class="d-flex gap-2 align-items-center">
      ...
      <a class="btn btn-sm btn-primary" href="<?= site_url('admin/publishers/create') ?>">Tambah Publisher</a>
    </div>
  </div>
  <div class="card-body pt-2">
    <div class="activity-table-wrap myletters-table-wrap table-responsive">
      <table class="table table-hover align-middle mb-0 w-100">
        <thead><tr><th>NO</th><th>KODE</th><th>NAMA</th><th>EMAIL</th><th>PHONE</th><th>ALAMAT</th><th>AKSI</th></tr></thead>
        <tbody>
